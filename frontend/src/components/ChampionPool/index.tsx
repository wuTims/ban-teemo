// frontend/src/components/ChampionPool/index.tsx
...
export function ChampionPool({
  ...
  return (
    <div className="bg-lol-dark rounded-lg p-2 sm:p-3 lg:p-4 flex flex-col h-[600px] lg:h-[800px] xl:h-[800px]">
      {/* Search */}
      <input
        type="text"
      ...
      <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden scrollbar-none p-1 lg:p-1.5">
        <div className="grid grid-cols-5 sm:grid-cols-6 md:grid-cols-8 lg:grid-cols-[repeat(auto-fill,minmax(72px,1fr))] xl:grid-cols-[repeat(auto-fill,minmax(76px,1fr))] 2xl:grid-cols-[repeat(auto-fill,minmax(84px,1fr))] gap-1 lg:gap-1.5 content-start auto-rows-max">
